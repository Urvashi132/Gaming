...
if (assetVocabulary != null) {
	vocabularyTitle = assetVocabulary.getTitle(locale);
      ...
      _jspx_th_liferay$1ddm_template$1renderer_0.setClassName( CPAssetCategoriesNavigationPortlet.class.getName() );
      _jspx_th_liferay$1ddm_template$1renderer_0.setContextObjects( contextObjects );
      _jspx_th_liferay$1ddm_template$1renderer_0.setDisplayStyle( cpAssetCategoriesNavigationDisplayContext.getDisplayStyle() );
      _jspx_th_liferay$1ddm_template$1renderer_0.setDisplayStyleGroupId( cpAssetCategoriesNavigationDisplayContext.getDisplayStyleGroupId() );
      _jspx_th_liferay$1ddm_template$1renderer_0.setEntries( assetCategories );
      ...
      if (_jspx_eval_liferay$1ddm_template$1renderer_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_liferay$1ui_panel$1container_0.setId( liferayPortletResponse.getNamespace() + "taglibAssetCategoriesNavigationPanel" );
        ...
        if (_jspx_eval_liferay$1ui_panel$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_liferay$1ui_panel_0.setTitle( HtmlUtil.escape(vocabularyTitle) );
  ...
  private boolean _jspx_meth_aui_script_0(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ddm_template$1renderer_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t);\n");
        out.write("\n");
        out.write("\t\ttreeViews.each((item, index, collection) => {\n");
        ...
        out.write("\t\t\t}).render();\n");
        out.write("\n");
        out.write("\t\t\tvar selected = assetCategoryList.one('.tree-node .tag-selected');\n");
        out.write("\n");
        ...
        out.write("\n");
        out.write("\t\t\t\tselectedChild.eachParent((node) => {\n");
