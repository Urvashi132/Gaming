 ...
 layout != null ) {
      ...
      if (_jspx_eval_liferay$1util_html$1top_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\t\t\t\t<link href=\"");
          out.print( PortalUtil.getStaticResourceURL(request, PortalUtil.getPathModule() + "/product-navigation-control-menu-web/css/App.css") );
      ...
      out.write("\t\t\t");
if (
 addContentPanelDisplayContext.showAddPanel() ) {
      out.write("\n");
      out.write("\t\t\t\t<div class=\"add-content-menu\" data-qa-id=\"addPanelBody\" id=\"");
      ...
      _jspx_th_react_component_0.setModule("js/AddPanel");
      _jspx_th_react_component_0.setProps( addContentPanelDisplayContext.getAddContentPanelData() );
  ...
  private boolean _jspx_meth_liferay$1ui_message_0(PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_0.setKey("please-sign-in-to-continue");
